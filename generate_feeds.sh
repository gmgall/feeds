...
newslinkrss \
	-p '.+html' \
	-i '.*/template-license.html' \
	-i '.*/contact.html' \
	-i '.*/vim.html' \
	-i '.*/sitemap\..*' \
	--follow \
	--with-body \
	--title-regex "(.*) - Leah Rowe's Sleepless Rants" \
	--body-xpath '//body/div[@class="page"]/ul[@class="quicknav"]/following-sibling::*' \
	--body-remove-xpath '//div[@id="footer"]' \
	--body-remove-xpath '//p[contains(text(), "Markdown file for this page:")]' \
	--body-remove-xpath '//p[contains(., "Site map")]' \
	--body-remove-xpath '//p[contains(text(), "This HTML page was generated by the")]' \
	--date-from-xpath '//p[contains(text(), "Date of publication: ")]/text()' \
	--xpath-date-regex '^Date of publication: ([0-9]{1,2} .+ [0-9]{4})( \(updated on.*\))?$' \
	'https://vimuser.org/'
	--locale 'en_US.UTF-8'
	-o ./feeds/leahrowe.xml
